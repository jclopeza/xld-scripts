...
# ./cli.sh -f /home/jcla/Projects/xld-scripts/voting-app/createXLDVotingAppResources.py
...
def createOrUpdateDictionary(env):
    dictionaryName = "Environments/dictionaries-voting-app/dictionary-application-voting-app-{0}".format(env)
...
def createOrUpdateEnvironment(env):
    environmentName = "Environments/application-voting-app/application-voting-app-{0}/application-voting-app-{0}".format(env)
    dictionaryName = "Environments/dictionaries-voting-app/dictionary-application-voting-app-{0}".format(env)
...
createResource("Environments/dictionaries-voting-app", "core.Directory", None)
...
createResource("Environments/application-voting-app", "core.Directory", None)
createResource("Environments/application-voting-app/application-voting-app-dev", "core.Directory", None)
createResource("Environments/application-voting-app/application-voting-app-pre", "core.Directory", None)
createResource("Environments/application-voting-app/application-voting-app-pro", "core.Directory", None)
...
createResource("Applications/Applications/application-voting-app", "core.Directory", None)
createResource("Applications/Applications/application-voting-app/bdd-voting-app", "udm.Application", None)
createResource("Applications/Applications/application-voting-app/front-voting-app", "udm.Application", None)
createResource("Applications/Applications/application-voting-app/worker-voting-app", "udm.Application", None)
createResource("Applications/Applications/application-voting-app/voting-app", "udm.Application", None)
...
# Creamos el pipeline
createResource("Configuration/pipeline-voting-app", "release.DeploymentPipeline", {'pipeline': getEnvironments('voting-app')})

# Y lo asociamos
bdd = repository.read("Applications/Applications/application-voting-app/bdd-voting-app")
front = repository.read("Applications/Applications/application-voting-app/front-voting-app")
worker = repository.read("Applications/Applications/application-voting-app/worker-voting-app")
voting_app = repository.read("Applications/Applications/application-voting-app/voting-app")
bdd.pipeline = "Configuration/pipeline-voting-app"
front.pipeline = "Configuration/pipeline-voting-app"
worker.pipeline = "Configuration/pipeline-voting-app"
voting_app.pipeline = "Configuration/pipeline-voting-app"
repository.update(bdd)
repository.update(front)
repository.update(worker)
repository.update(voting_app)